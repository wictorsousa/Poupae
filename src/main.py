...
class Dashboard(customtkinter.CTk):
    def __init__(self):
        ...
        self.FONT_CARD_TITULO = ('Arial', 14)
        self.FONT_VALOR_CARD = ('Arial', 28, 'bold')
        self.FONT_TITULO_SECAO = ('Arial', 11, 'bold')
    ...
    def setup_ui(self):
        ...
        self.combo_categoria_despesas = customtkinter.CTkComboBox(self.frame_operacoes_card, values=[i[1] for i in ver_categorias_gastos()], font=self.FONT_LABEL, width=140, corner_radius=8, fg_color=self.COR_BRANCA)
        ...
        self.e_valor_despesas = customtkinter.CTkEntry(self.frame_operacoes_card, width=140, justify='left', corner_radius=8)
        ...
        self.e_nova_categoria_gasto = customtkinter.CTkEntry(self.frame_operacoes_card, width=140, justify='left', corner_radius=8)
        ...
        self.combo_categoria_receitas = customtkinter.CTkComboBox(self.frame_configuracao_card, values=[i[1] for i in ver_categorias_receitas()], font=self.FONT_LABEL, width=140, corner_radius=8, fg_color=self.COR_BRANCA)
        ...
        self.e_valor_receitas = customtkinter.CTkEntry(self.frame_configuracao_card, width=140, justify='left', corner_radius=8)
        ...
        self.e_nova_categoria_receita = customtkinter.CTkEntry(self.frame_configuracao_card, width=140, justify='left', corner_radius=8)
    ...
    def grafico_pie_receitas(self):
        ...
        dados_pie = pie_valores_receitas()
        ...
        for categoria, cor in zip(lista_categorias, self.lista_cores_pizza):
            legend_elements.append(Line2D([0], [0], marker='o', color='w', label=categoria, markerfacecolor=cor, markersize=10))
        legenda = ax.legend(handles=legend_elements, loc="center right", bbox_to_anchor=(1.7, 0.5), frameon=False, prop={'size': 11})
    ...
    def adicionar_categoria_gasto_b(self):
        ...
        if nome == '':
            ...
            return
        inserir_categoria_gasto([nome])
        messagebox.showinfo('Sucesso', 'Categoria de gasto adicionada!')
        self.e_nova_categoria_gasto.delete(0, 'end')
        self.combo_categoria_despesas.configure(values=[i[1] for i in ver_categorias_gastos()])
    ...
    def inserir_despesas_b(self):
        ...
        try: quantia = float(self.e_valor_despesas.get().replace(",", "."))
        except (ValueError, TypeError):
            messagebox.showerror('Erro', 'Digite um valor numérico válido.')
            return
        if nome == '' or data == '' or not quantia:
